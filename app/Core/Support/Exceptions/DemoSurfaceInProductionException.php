...
namespace App\Core\Support\Exceptions;
 ...
 * `php artisan db:seed --class=DemoAdminSeeder` PEDIU aquele super admin. Se
 * o comando terminar com "DONE" sem criar nada, a pessoa acredita que a
 * conta existe — e passa a depender de algo que não está lá. Pior: se ela
