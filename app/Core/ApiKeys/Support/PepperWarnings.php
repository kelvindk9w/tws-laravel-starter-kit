 ...
 * de segurança por uma indisponibilidade (o critério do
 * App\Core\Support\CriticalSecrets). O remédio é a transição documentada:
 * pepper dedicado + peppers anteriores (e, para chaves emitidas com pepper
 * vazio, a flag do legado).
 *
 * Duas condições:
 *
