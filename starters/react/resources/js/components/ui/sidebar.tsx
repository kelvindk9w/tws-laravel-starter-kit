    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetHeader className="sr-only">
          <SheetTitle>{t("ui.nav.menu")}</SheetTitle>
          <SheetDescription>{t("ui.nav.site")}</SheetDescription>
        </SheetHeader>
        <SheetContent
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">{t("ui.nav.toggle_sidebar")}</span>
    </Button>
  )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label={t("ui.nav.toggle_sidebar")}
      tabIndex={-1}
      onClick={toggleSidebar}
      title={t("ui.nav.toggle_sidebar")}
      className={cn(
