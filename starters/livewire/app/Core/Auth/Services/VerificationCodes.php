...
final class VerificationCodes
{
     ...
     * (cooldownRemaining()).
     */
    public function issue(User $user, VerificationPurpose $purpose, ?VerificationChannel $channel = null): VerificationCode
    {
     ...
     */
    public function verify(User $user, VerificationPurpose $purpose, #[\SensitiveParameter] string $code): VerificationResult
    {
     ...
     */
    public function invalidate(User $user, VerificationPurpose $purpose): void
    {
        VerificationCode::query()
     ...
     */
    public function cooldownRemaining(User $user, VerificationPurpose $purpose, ?VerificationChannel $channel = null): int
    {
        $channel ??= $this->channels->defaultChannel();
     ...
     */
    public function hasActive(User $user, VerificationPurpose $purpose): bool
    {
        $record = $this->latestActive($user, $purpose);
    ...
    private function latestActive(User $user, VerificationPurpose $purpose): ?VerificationCode
    {
