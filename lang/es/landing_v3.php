...
// Strings de la landing «Cielo» (v3, ruta /v3) — español (ADR-007).
//
...
// rompería esa promesa justo en la página que vende el kit — por eso la v3 sale
// traducida de verdad, igual que el resto de lang/es.
//
// Los NÚMEROS (clones, tests) no viven aquí: vienen de config/landing_v3.php.

return [

    'meta' => [
        'title' => 'El Laravel que ya viene hecho',
        'description' => 'Starter kit de Laravel con autenticación, API keys, panel, super admin, subidas seguras, backup y suite de tests — clónalo y empieza por tu producto.',
    ],
    ...
    'hero' => [
        ...
        'title_line_1' => 'El Laravel que',
        'title_line_2' => 'ya viene hecho',
        'subtitle' => 'Tres meses en autenticación, logs y subidas antes de la primera pantalla de tu producto: otra vez no.',
        'cta_primary' => 'Clonar',
