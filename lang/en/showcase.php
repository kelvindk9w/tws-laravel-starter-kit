...
return [
    ...
    'theme_tokens' => [
        ...
        'brand' => 'Brand color',
        'brand_hint' => 'Monochromatic default (Vercel/Linear): near-black in light mode, near-white in dark — --color-brand/--color-brand-foreground tokens in theme.css, flipped by the .dark class. Optional override: PLATFORM_PRIMARY_COLOR in the .env becomes --brand in the <head> (no rebuild), applying to both themes.',
        'brand_unset' => 'empty = neutral',
        'fonts' => 'Typography',
    ...
    'form_patterns' => [
        ...
        'classic_guide' => 'When to use: simple public forms (contact, login, registration). State repopulated with old(). Submissions are really saved to form_submissions and appear in the super admin — try an attack (<script>, SQLi, honeypot) and see the blocked attempt with a red badge at the top of the list.',
        ...
        'demo_nickname_placeholder' => 'How it appears in the admin list',
        'demo_message_placeholder' => 'At least 10 characters…',
        'demo_submit' => 'Send demo',
        'demo_submit_ajax' => 'Send message',
        'demo_sent' => 'Demo sent! The flash became this toast and the submission appears in the admin (/admin, Form submissions).',
        'demo_sent_title' => 'Submission recorded',
        'demo_send_another' => 'Send another',
        'demo_honeypot_label' => 'Website',
        'ajax_heading' => 'Livewire — wire:submit (AJAX, functional)',
        'ajax_guide' => 'When to use: rich interactions without reload (panel, modals, stateful forms). Automatic server-side validation and preserved fields (there is no old() in Livewire). Saved to form_submissions just like the classic one — attacks are blocked by the form layer and shown in the admin.',
    ],
