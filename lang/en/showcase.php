...
return [
    ...
    'data_display' => [
        'guide' => 'The three components the dashboard and the panel listings consume. Rule: a table to compare rows, a stat for a number that matters on its own, a chart for a trend — never a chart for 3 values.',
        'table_heading' => 'Table',
        'table_hint' => 'Columns declared in :headers. BELOW sm: the table turns into cards and each cell shows its own label — no hidden horizontal scroll, no cut-off column. Routine actions as small secondary buttons; the destructive one in the ⋯ menu.',
        'col_name' => 'Name',
        'col_status' => 'Status',
        'col_actions' => 'Actions',
        ...
        'row_action' => 'Edit',
        'stat_heading' => 'Stat',
        'stat_hint' => 'The number is the hero (display, tabular-nums); the label is caption. With href the whole card becomes the click target.',
        'stat_keys' => 'Active keys',
        'stat_projects' => 'Projects',
        'stat_requests' => 'Requests',
        'stat_hint_days' => 'last 7 days',
        'chart_heading' => 'Chart',
        'chart_hint' => 'Chart.js served by Vite (runs under the strict CSP: no eval). Colours come from the tokens at runtime — change --color-brand and the chart changes with it, and dark mode comes from the same place as the rest of the interface.',
        'chart_with_data' => 'With data',
        'chart_empty' => 'No data',
        'chart_series' => 'Requests',
        'chart_empty_hint' => 'A chart with zeroed axes says nothing and reads as a defect: the component draws the empty state instead.',
    ],

    'navigation' => [
        'guide' => 'Menus, drawers and selectors. All share the same engine in resources/js/ui.js: they close on Esc, on the outside click/backdrop, and return focus to whoever opened them.',
        'dropdown_heading' => 'Dropdown',
        'dropdown_hint' => 'Menu anchored to its trigger. Keyboard: arrows move, Home/End jump to the ends. The active item is marked with ✓; the destructive one is the only red.',
        'dropdown_trigger' => 'Actions',
        'dropdown_item_active' => 'Current option',
        'dropdown_item' => 'Edit',
        'dropdown_item_danger' => 'Delete',
        'drawer_heading' => 'Drawer',
        'drawer_hint' => 'Same engine as the modal, different geometry: a panel docked to the edge. It is the mobile navigation of the panel and the landing below sm:.',
        'drawer_demo' => 'Open drawer',
        'drawer_title' => 'Menu',
