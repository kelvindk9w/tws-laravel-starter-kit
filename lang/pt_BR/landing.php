...
return [
    ...
    'stack' => [
        ...
        'dev_note' => 'Ambiente dev completo no compose: Mailpit (caixa de entrada de e-mails), Horizon (filas) e scheduler — sem instalar nada além do Docker.',
    ],
    ...
    'hours' => [
        ...
        'total_unit' => 'horas de trabalho já feitas',
        'total_caption' => 'Estimativa conservadora do que já vem implementado, testado e documentado — item a item abaixo.',
    ],
    ...
    'cta' => [
        ...
        'repo' => 'Ver o código no repositório',
        'register' => 'Criar conta',
        'demo' => 'Testar demo',
        'login' => 'Entrar',
    ],
