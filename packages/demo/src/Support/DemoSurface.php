...
namespace Twstec\Kit\Demo\Support;
 ...
 * DemoServiceProvider grava um aviso no log a cada boot: um opt-out de
 ...
 *              CONTINUAM registradas (os links que a demo põe no rodapé e no
 *              menu do site geram `route('ui.showcase')` incondicionalmente
 *              — desregistrar derrubaria a home com RouteNotFoundException).
 *
 *   SEEDER   → exceção, quando chamado DIRETAMENTE (ver
 *              DemoSurfaceInProductionException).
 *
 *   AGREGADOR→ o DemoSeeder (chamado pelo DatabaseSeeder) pula a demo com
 *              aviso, em vez de estourar: ele roda no que um script de deploy
 *              executa, e recusar o deploy inteiro por causa de dado de
 *              demonstração seria trocar uma armadilha por outra.
 */
