...
<head>
    ...
    <link rel="preload" as="image" href="{{ Vite::asset('vendor/twstec/kit-demo/resources/img/landing/dashboard-light-1440.webp') }}" imagesrcset="{{ Vite::asset('vendor/twstec/kit-demo/resources/img/landing/dashboard-light-720.webp') }} 720w, {{ Vite::asset('vendor/twstec/kit-demo/resources/img/landing/dashboard-light-1440.webp') }} 1440w" imagesizes="(max-width: 640px) 80vw, 30rem" fetchpriority="high">

    @vite(['resources/css/app.css', 'resources/js/app.js', 'vendor/twstec/kit-demo/resources/css/landing.css', 'vendor/twstec/kit-demo/resources/js/landing.js'])
</head>
