...
@php
    ...
    // Quatro telas REAIS, capturadas em 1440×900 (resources/img/landing).
        ...
        <div class="sky-fan sky-rise" data-sky-fan>
            @foreach ($screens as $screen)
                ...
                >
                    ...
                    <img
                        src="{{ Vite::asset("vendor/twstec/kit-demo/resources/img/landing/{$key}-light-1440.webp") }}"
                        srcset="{{ Vite::asset("vendor/twstec/kit-demo/resources/img/landing/{$key}-light-720.webp") }} 720w, {{ Vite::asset("vendor/twstec/kit-demo/resources/img/landing/{$key}-light-1440.webp") }} 1440w"
                    ...
                    >
                    <img
                        src="{{ Vite::asset("vendor/twstec/kit-demo/resources/img/landing/{$key}-dark-1440.webp") }}"
                        srcset="{{ Vite::asset("vendor/twstec/kit-demo/resources/img/landing/{$key}-dark-720.webp") }} 720w, {{ Vite::asset("vendor/twstec/kit-demo/resources/img/landing/{$key}-dark-1440.webp") }} 1440w"
                        sizes="(max-width: 640px) 80vw, 21rem"
                        alt="{{ __("landing.hero.screens.{$key}.alt") }}"
                        width="1440"
                        height="900"
