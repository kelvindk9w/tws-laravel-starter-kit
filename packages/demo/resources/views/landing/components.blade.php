    ...
    <div class="mx-auto max-w-6xl px-4">
        ...
        >
            ...
            <div class="sky-split-pane sky-split-screen">
                <img
                    src="{{ Vite::asset('vendor/twstec/kit-demo/resources/img/landing/table-light-900.webp') }}"
                    srcset="{{ Vite::asset('vendor/twstec/kit-demo/resources/img/landing/table-light-600.webp') }} 600w, {{ Vite::asset('vendor/twstec/kit-demo/resources/img/landing/table-light-900.webp') }} 900w"
                ...
                >
                <img
                    src="{{ Vite::asset('vendor/twstec/kit-demo/resources/img/landing/table-dark-900.webp') }}"
                    srcset="{{ Vite::asset('vendor/twstec/kit-demo/resources/img/landing/table-dark-600.webp') }} 600w, {{ Vite::asset('vendor/twstec/kit-demo/resources/img/landing/table-dark-900.webp') }} 900w"
                    sizes="(max-width: 640px) 92vw, 46rem"
                    alt="{{ __('landing.components.screen_alt') }}"
                    width="900"
                    height="245"
