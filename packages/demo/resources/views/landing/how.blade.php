            ...
            @foreach (__('landing.how.steps') as $step)
                ...
                <li class="sky-step sky-rise" style="--sky-delay: {{ $loop->index * 90 }}ms">
                    <div class="sky-step-collage">
                        <img
                            src="{{ Vite::asset("vendor/twstec/kit-demo/resources/img/landing/{$collage}-light-720.webp") }}"
                            alt=""
                            width="720"
                            height="450"
                            loading="lazy"
                        ...
                        >
                        <img
                            src="{{ Vite::asset("vendor/twstec/kit-demo/resources/img/landing/{$collage}-dark-720.webp") }}"
                            alt=""
                            width="720"
                            height="450"
                            loading="lazy"
