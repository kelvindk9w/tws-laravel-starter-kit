...
<x-layouts.landing :title="__('showcase.title').' — '.platform()->name">
    <div class="mx-auto w-full max-w-6xl flex-1 px-4 py-8 lg:flex lg:gap-10 lg:py-12">
        ...
        <x-side-nav
            ...
            :groups="\Twstec\Kit\Demo\Showcase\ShowcaseIndex::groups()"
            spy
        />
                ...
                <div class="grid gap-8 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap items-end gap-4">
                            ...
                            <x-avatar :src="Vite::asset('vendor/twstec/kit-demo/resources/img/landing/dashboard-light-720.webp')" name="Ana Ribeiro" size="lg" />
                        </div>
                        <div class="mt-3 flex flex-col gap-2">
