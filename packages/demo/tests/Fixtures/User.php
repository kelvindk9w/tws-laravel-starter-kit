...
namespace Twstec\Kit\Demo\Tests\Fixtures;
...
/**
 * O model de usuário MÍNIMO de uma aplicação que instala o painel (o mesmo da
 * suíte do twstec/kit-admin): o do esqueleto Laravel + a trait e o contrato do
 * twstec/kit-auth + a foto de perfil do twstec/kit-uploads + o contrato do
 * Filament. Nada do starter — a proteção das contas demo tem de valer por ele.
 */
