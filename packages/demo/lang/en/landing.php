...
//
// The `nav.*` and `footer.*` keys used by the PRODUCT header, footer and home
// page (sign in, create account, institutional footer) live in the
// application's lang/, in the same `landing` group; these join them.
