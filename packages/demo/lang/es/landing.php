...
// config/landing.php. Las claves de `nav.*` y `footer.*` que usan la cabecera,
// el pie y la página inicial del PRODUCTO viven en el lang/ de la aplicación,
// en el mismo grupo `landing`; las de aquí se suman a ellas.
