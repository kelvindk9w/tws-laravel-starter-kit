...
// unen a estos en el mismo grupo `admin.*`: en una misma clave, este archivo
// gana al paquete twstec/kit-admin, y el lang/ de la aplicación gana a los dos.
...
return [
    ...
    // Texto "de demo" de los mensajes NEUTROS del producto sobre cuenta
    // protegida (twstec/kit-admin): con la demostración instalada, la cuenta
    // protegida es la cuenta demo. Sin ella, vale el texto neutro del paquete.
    'users' => [
        'account_protected' => 'Cuenta de demostración protegida: los usuarios demo no pueden ser bloqueados, editados ni eliminados.',
        'demo_protected' => 'Cuenta de demostración protegida: los usuarios demo no pueden ser bloqueados, editados ni eliminados.',
    ],

    'command' => [
        'account_protected' => 'Cuenta de demostración protegida: el comando no modifica :email.',
