...
// no mesmo grupo `admin.*`: numa mesma chave, este arquivo vence o pacote
// twstec/kit-admin, e o lang/ do aplicativo vence os dois.
...
return [
    ...
    // Texto "de demo" das mensagens NEUTRAS do produto sobre conta protegida
    // (twstec/kit-admin): com a demonstração instalada, a conta protegida é a
    // conta demo. Sem ela, vale o texto neutro do pacote.
    'users' => [
        'account_protected' => 'Conta de demonstração protegida: usuários demo não podem ser bloqueados, editados ou excluídos.',
        'demo_protected' => 'Conta de demonstração protegida: usuários demo não podem ser bloqueados, editados ou excluídos.',
    ],

    'command' => [
        'account_protected' => 'Conta de demonstração protegida: o comando não altera :email.',
