...
//
// As chaves de `nav.*` e de `footer.*` que o cabeçalho, o rodapé e a página
// inicial do PRODUTO usam (entrar, criar conta, rodapé institucional) moram no
// lang/ do aplicativo, no mesmo grupo `landing`; as daqui se juntam a elas.
