...
// cadastro não aceita e-mail repetido. Essas contas ficam no banco de dev —
// para limpar: DELETE das contas `e2e-verificacao-%@example.com`
// (ver docs/testes.md).
// =============================================================================
...
test.describe('verificação de e-mail no cadastro', () => {
    ...
    test('cadastro → aviso → e-mail no Mailpit → link → painel liberado', async ({ page, request }) => {
        ...
        // Limpa a caixa do Mailpit (a conta de teste é removida do banco à parte).
