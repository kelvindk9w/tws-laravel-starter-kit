...
<section id="como-funciona" class="scroll-mt-24 bg-surface pb-24 sm:pb-32">
    <div class="mx-auto max-w-6xl px-4">
        <div class="v3-rise mx-auto max-w-3xl text-center">
            <h2 class="v3-title text-gray-900 dark:text-gray-50" data-v3-text>{{ __('landing_v3.how.title') }}</h2>
            <p class="v3-lede mx-auto mt-4" data-v3-text>{{ __('landing_v3.how.subtitle') }}</p>
        </div>

        <ol class="mt-14 grid gap-6 md:grid-cols-3">
            @foreach (__('landing_v3.how.steps') as $step)
                @php $collage = $collages[$loop->index]; @endphp
                <li class="v3-step v3-rise" style="--v3-delay: {{ $loop->index * 90 }}ms">
                    <div class="v3-step-collage">
                        <img
                            src="{{ asset("img/landing-v3/{$collage}-light-720.webp") }}"
                            alt=""
                            width="720"
                            height="450"
                            loading="lazy"
                        ...
                        >
                        <img
                            src="{{ asset("img/landing-v3/{$collage}-dark-720.webp") }}"
                            alt=""
                            width="720"
                            height="450"
                            loading="lazy"
                        ...
                        <span class="v3-cursor {{ $spots[$loop->index] }}">
                    ...
                    <div class="p-6">
                        ...
                        <code class="mt-4 block overflow-x-auto rounded-lg border border-border bg-surface px-3 py-2 font-mono text-xs text-gray-700 dark:text-gray-300" data-v3-scroll>{{ $step['command'] }}</code>
                    </div>
                </li>
            @endforeach
        </ol>
