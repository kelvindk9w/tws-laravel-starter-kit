    ...
    <header class="border-b border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
        <div class="mx-auto flex max-w-5xl flex-wrap items-center gap-x-6 gap-y-2 px-4 py-3">
            ...
            <nav class="flex flex-1 flex-wrap items-center gap-1 text-sm">
                <a href="{{ route('dashboard') }}" @class(['rounded-md px-3 py-1.5', 'bg-brand text-brand-foreground' => request()->routeIs('dashboard'), 'hover:bg-gray-100 dark:hover:bg-gray-800' => ! request()->routeIs('dashboard')])>{{ __('panel.nav.dashboard') }}</a>
                <a href="{{ route('panel.api-keys') }}" @class(['rounded-md px-3 py-1.5', 'bg-brand text-brand-foreground' => request()->routeIs('panel.api-keys'), 'hover:bg-gray-100 dark:hover:bg-gray-800' => ! request()->routeIs('panel.api-keys')])>{{ __('panel.nav.api_keys') }}</a>
                <a href="{{ route('panel.projects') }}" @class(['rounded-md px-3 py-1.5', 'bg-brand text-brand-foreground' => request()->routeIs('panel.projects'), 'hover:bg-gray-100 dark:hover:bg-gray-800' => ! request()->routeIs('panel.projects')])>{{ __('panel.nav.projects') }}</a>
                <a href="{{ route('panel.notifications') }}" @class(['rounded-md px-3 py-1.5', 'bg-brand text-brand-foreground' => request()->routeIs('panel.notifications'), 'hover:bg-gray-100 dark:hover:bg-gray-800' => ! request()->routeIs('panel.notifications')])>{{ __('panel.nav.notifications') }}</a>
                <a href="{{ route('panel.profile') }}" @class(['rounded-md px-3 py-1.5', 'bg-brand text-brand-foreground' => request()->routeIs('panel.profile'), 'hover:bg-gray-100 dark:hover:bg-gray-800' => ! request()->routeIs('panel.profile')])>{{ __('panel.nav.profile') }}</a>
            </nav>
